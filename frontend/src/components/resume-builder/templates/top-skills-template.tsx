...
// Top Skills template - Skills section prominently at top after header
...
interface TopSkillsTemplateProps {
  data: ResumeData
  settings: ResumeSettings
}

export function TopSkillsTemplate({ data, settings }: TopSkillsTemplateProps) {
  ...
  return (
    <Document>
      <Page size="A4" style={styles.page}>
        ...
        {skills.length > 0 && (
          <View style={styles.skillsHighlight}>
            <Text style={styles.skillsTitle}>Core Skills</Text>
