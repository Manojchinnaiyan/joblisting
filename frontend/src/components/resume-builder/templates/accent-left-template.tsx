...
// Accent Left template - Colored accent bar on left side
...
interface AccentLeftTemplateProps {
  data: ResumeData
  settings: ResumeSettings
}

export function AccentLeftTemplate({ data, settings }: AccentLeftTemplateProps) {
